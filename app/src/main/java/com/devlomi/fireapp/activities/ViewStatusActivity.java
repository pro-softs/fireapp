...
import com.devlomi.fireapp.utils.KeyboardUtils;
...
public class ViewStatusActivity extends BaseActivity implements StoriesProgressView.StoriesListener, PullBackLayout.Callback, StatusSeenByCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        seenByBottomsheetBehavior.addBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            @Override
        ...
        replyBehavior.addBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            @Override
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
    ...
    private void pickContact() {
        new MultiContactPicker.Builder(ViewStatusActivity.this)
                .handleColor(ContextCompat.getColor(ViewStatusActivity.this, R.color.primaryColor))
                .bubbleColor(ContextCompat.getColor(ViewStatusActivity.this, R.color.primaryColor))
    ...
    private void initViews() {
        ...
        emojIcon = new EmojIconActions(getApplicationContext(), root, etMessage, emojiBtn, "#495C66", "#DCE1E2", "#E6EBEF");

    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (message != null) {
            ...
            if (message.isTextMessage() || message.getType() == MessageType.GROUP_EVENT || MessageType.isDeletedMessage(message.getType())) {
                ...
                if (message.getType() == MessageType.GROUP_EVENT && !chat.getChatId().equalsIgnoreCase(ChatActivity.PUBLIC_GROUP_ID)) {
                    ...
                    if(!chat.getChatId().equalsIgnoreCase(ChatActivity.PUBLIC_GROUP_ID)){
                        mHolder.tvLastMessage.setText(content);
                    }
                else{
                        mHolder.tvLastMessage.setText("Tap for Public Chat");
                    }
